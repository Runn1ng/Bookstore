            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="subscribe" class="col-md-4 col-form-label text-md-right">{{ __('Подписаться на рассылку') }}</label>

                            <div class="col-md-6">
                                <input id="subscribe" type="checkbox" class="form-control" name="subscribe" autocomplete="subscribe">
                            </div>
                        </div>
